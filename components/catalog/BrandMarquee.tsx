...
export function BrandMarquee() {
  const brands = [
    ...
    { name: "ON", icon: "https://upload.wikimedia.org/wikipedia/commons/4/41/On_Running_Logo.svg" },
    { name: "VANS", icon: "https://upload.wikimedia.org/wikipedia/commons/9/9d/Vans-logo.svg" },
  ]
