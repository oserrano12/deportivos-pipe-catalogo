      ...
      <div className="container max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            <img src="/IMAGOTIPO.svg" alt="Deportivos Pipe" width={240} height={96} className="h-16 md:h-24 w-auto object-contain mb-2" />
          ...
          <div className="space-y-4 md:ml-auto">
            ...
            <div className="flex gap-4">
              ...
              <a 
                href="https://www.facebook.com/profile.php?id=100071203216331"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-background border flex items-center justify-center text-muted-foreground hover:text-white hover:border-transparent hover:bg-[#1877F2] transition-colors"
                aria-label="Facebook"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5">
