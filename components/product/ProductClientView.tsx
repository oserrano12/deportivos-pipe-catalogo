            ...
            <div className="pt-2">
              <Dialog>
                ...
                <DialogContent className="sm:max-w-md border-4 border-foreground rounded-none shadow-[8px_8px_0_0_oklch(var(--color-foreground))] bg-background">
                  <DialogHeader>
                    <DialogTitle className="font-black text-2xl uppercase italic tracking-tighter flex items-center gap-2">
                  ...
                  <div className="flex flex-col gap-3 mt-4">
                    <a 
                      ...
                      className="w-full bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-white px-4 py-4 font-black text-center text-sm uppercase tracking-widest hover:scale-[1.02] active:scale-95 transition-transform"
                    >
                      Ir a Instagram y Ver Video
                    </a>
                  </div>
                </DialogContent>
              </Dialog>
